...
Configuration in sosotech directory creates:
...
To run sosotech example you need to execute:
...
Note that sosotech example may create resources which will incur monetary charges on your AWS bill. Run `terraform destroy` when you no longer need these resources.
