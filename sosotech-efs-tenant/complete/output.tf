...
output "arn" {
  description = "Resource Name of the file system"
...
output "dns_name" {
  description = "The DNS name for the filesystem (http://docs.aws.amazon.com/efs/latest/ug/mounting-fs-mount-cmd-dns-name.html)"
  value       = module.efs.dns_name
}

output "size_in_bytes" {
  description = "The latest known metered size of data stored in the file system, the value is not the exact size that the file system was at any point in time"
